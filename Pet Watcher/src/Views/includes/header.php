...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Anek+Gujarati:wght@400;700&display=swap" rel="stylesheet">
...
<nav class="border-gray-200 bg-gray-50 dark:border-Neutral-100">
  ...
  <div class="w-full bg-amber-700/35 p-3 grid grid-cols-10 " alt="Empreinte de Chat">
    <img src="/assets/img/icons8-empreinte-de-chat-50.png" class="h-7 w-7 rotate-90 " >
    <img src="/assets/img/icons8-empreinte-de-chat-50.png" class="h-7 w-7 rotate-45 " >
    <img src="/assets/img/icons8-empreinte-de-chat-50.png" class="h-7 w-7 rotate-90 " >
    <img src="/assets/img/icons8-empreinte-de-chat-50.png" class="h-7 w-7 rotate-45 " >
    <img src="/assets/img/icons8-empreinte-de-chat-50.png" class="h-7 w-7 rotate-90 " >
    <img src="/assets/img/icons8-empreinte-de-chat-50.png" class="h-7 w-7 rotate-45 " >
